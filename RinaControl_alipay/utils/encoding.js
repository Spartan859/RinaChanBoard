...
(function(_global) {
    ...
    if (
        ...
        module.exports &&
        !_global["encoding-indexes"]
    ) {
        _global["encoding-indexes"] = require("./encoding-indexes.js")[
            "encoding-indexes"
        ];
    }
     ...
     *  */
    function index(name) {
        if (!("encoding-indexes" in _global)) {
            throw Error(
                "Indexes missing." +
                    " Did you forget to include encoding-indexes.js first?"
            );
        }
        return _global["encoding-indexes"][name];
    }
    ...
    function TextEncoder(label, options) {
        ...
        if (Boolean(options["NONSTANDARD_allowLegacyEncoding"])) {
            ...
            if (label !== undefined && "console" in _global) {
                console.warn(
    ...
    (function() {
        if (!("encoding-indexes" in _global)) return;
        encodings.forEach(function(category) {
            ...
            if (gb18030_third !== 0x00) {
                ...
                if (inRange(bite, 0x30, 0x39)) {
                    code_point = indexGB18030RangesCodePointFor(
                        (((gb18030_first - 0x81) * 10 + gb18030_second - 0x30) *
                            126 +
                            gb18030_third -
                            0x81) *
                            10 +
            ...
            switch (iso2022jp_decoder_state) {
                ...
                case states.TrailByte:
                    ...
                    if (inRange(bite, 0x21, 0x7e)) {
                        ...
                        var pointer =
                            (iso2022jp_lead - 0x21) * 94 + bite - 0x21;
    ...
    if (!_global["TextEncoder"]) _global["TextEncoder"] = TextEncoder;
    if (!_global["TextDecoder"]) _global["TextDecoder"] = TextDecoder;
    if (typeof module !== "undefined" && module.exports) {
        module.exports = {
            TextEncoder: _global["TextEncoder"],
            TextDecoder: _global["TextDecoder"],
            EncodingIndexes: _global["encoding-indexes"]
        };
    }
