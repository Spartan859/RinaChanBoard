...
.weui-btn_default:not(.weui-btn_disabled).weui-active {
...
.weui-btn_primary:not(.weui-btn_disabled).weui-active {
...
.weui-btn_warn:not(.weui-btn_disabled).weui-active {
    background-color: var(--weui-BTN-DEFAULT-ACTIVE-BG);
}
...
.antmove-weui-btn:not(.weui-btn_mini) + .antmove-weui-btn:not(.weui-btn_mini) {
    margin-top: 16px;
}
...
.weui-btn_icon.weui-active [class*="weui-icon-"] {
    color: var(--weui-FG-1);
}
...
.weui-cells_form .weui-cell_disabled.weui-active,
.weui-cells_form .weui-cell_readonly.weui-active,
.weui-cells_form .weui-cell_switch.weui-active,
.weui-cells_form .weui-cell_vcode.weui-active {
    background-color: transparent;
}
...
.weui-form-preview__btn.weui-active {
    background-color: var(--weui-BG-COLOR-ACTIVE);
}
...
.weui-uploader__input-box.weui-active:after,
.weui-uploader__input-box.weui-active:before {
    opacity: 0.7;
}
...
.weui-half-screen-dialog {
    ...
    padding: 0 calc(24px + env(safe-area-inset-right))
        env(safe-area-inset-bottom) calc(24px + env(safe-area-inset-left));
}
...
.weui-half-screen-dialog__hd .weui-icon-btn.weui-active {
    opacity: 0.5;
}
...
[data-weui-theme="dark"]
    .weui-slideview__btn-group_default
    ~ .weui-slideview__btn-group_default:before {
...
.weui-navigation-bar__inner
    .weui-navigation-bar__left
    .weui-navigation-bar__btn_goback.weui-active {
    opacity: 0.5;
}
