    ...
    (function(modules) {
        ...
        [
            ...
            function(module, exports, __webpack_require__) {
                ...
                var _formValidator = _interopRequireDefault(
                ...
                Component({
                    ...
                    attached() {
                        this.initRules();
                        this.formValidator = new _formValidator.default(
                            this.data.models,
                            this.data.newRules
                        );
                    },
                    ...
                    methods: {
                        ...
                        _modelChange(newVal, oldVal) {
                            ...
                            const diffObj = (0, _object.diffObject)(
                                oldVal,
                                newVal
                            );
                        ...
                        validateField(
                            ...
                            return this.formValidator.validateField(
                                name,
                                value,
                                (isValid, errors) => {
                        ...
                        addMethod(ruleName, method) {
                            return this.formValidator.addMethod(
                                ruleName,
                                method
                            );
                        }
                ...
                const validateSingleRule = (
                    ...
                    for (let i = 0, l = ruleKeys.length; i < l; ++i) {
                        ...
                        const validateMethod =
                            typeof rule.validator !== "undefined"
                                ? rule.validator
                                : _validator.default[ruleKey];
                ...
                class FormValidator {
                    ...
                    validate(cb) {
                        return new Promise(resolve => {
                            ...
                            cb &&
                                cb(!failCount, failCount ? errors : undefined);
                        });
                    }
                        ...
                        return new Promise(resolve => {
                            this._innerValidateField(
                                ...
                                (valid, error) => {
                                    ...
                                    const errorChanged = (0, _object.diff)(
                                        oldError,
                                        error
                                    );
                    ...
                    _innerValidateField(name, value, cb) {
                        ...
                        if (!rules) {
                            console.warn(
                                `[form-validator] rule name ${name} not exists.`
                            );
                            cb(true);
                            return;
                        } // 处理参数
                ...
                var _default = {
                    required(r, val) {
                        if (r.required === false) return "";
                            ...
                            return (0, _string.sprintf)(
                                r.message || defaultMessage.required,
                                r.name
                            );
                        else return "";
                    },
                    ...
                    minlength(r, val) {
                        ...
                        if (val.length < minlen)
                            return (0, _string.sprintf)(
                                r.message || defaultMessage.minlength,
                                minlen
                            );
                        else return "";
                    },
                    ...
                    maxlength(r, val) {
                        ...
                        if (val.length > maxlen) {
                            return (0, _string.sprintf)(
                                r.message || defaultMessage.maxlength,
                                maxlen
                            );
                        } else {
                            return "";
                    ...
                    rangelength(r, val) {
                        ...
                        if (val.length > range[1] || val.length < range[0]) {
                            return (0, _string.sprintf)(
                                r.message || defaultMessage.rangelength,
                                range[0],
                                range[1]
                            );
                        } else {
                    ...
                    range(r, val) {
                        ...
                        if (val < range[0] || val > range[1]) {
                            return (0, _string.sprintf)(
                                r.message || defaultMessage.range,
                                range[0],
                                range[1]
                            );
                        } else {
                    ...
                    mobile(r, val) {
                        ...
                        if (r.mobile === false) {
                            ...
                            return (0, _string.sprintf)(
                                r.message || defaultMessage.mobile
                            );
                        } else {
                            return "";
                        }
                    ...
                    email(r, value) {
                        ...
                        if (
                            ...
                            return (0, _string.sprintf)(
                                r.message || defaultMessage.email
                            );
                        } else {
                            return "";
                        }
                    ...
                    equalTo(r, value, param, models) {
                        ...
                        if (value !== models[equalTo]) {
                            return (0, _string.sprintf)(
                                r.message || defaultMessage.equalTo,
                                r.name
                            );
                        } else {
                            return "";
                    ...
                    bytelength(r, value, param) {
                        ...
                        if (len > param) {
                            return (0, _string.sprintf)(
                                r.message || defaultMessage.bytelength,
                                param
                            );
                        } else {
                            return "";
