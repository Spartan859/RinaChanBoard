  ...
  <view class='page__bd page__bd_spacing'>
    <view class='weui-progress'>
      ...
      <view class='weui-progress__opr'>
        <icon type='cancel' size='22' class=' iconcancel-style 22-style iconcancel-style 22-style'>
        </icon>
      </view>
    </view>
    <view class='weui-progress'>
    ...
    <view class='weui-btn-area'>
      <btn type='primary' disabled='{{disabled}}' class=' primary-style' onTap='antmoveAction' data-antmove-tap='upload'>
        上传
      </btn>
    </view>
  </view>
